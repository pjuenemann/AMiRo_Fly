...
%   ZRICHTUNGMERGED0206 = IMPORTFILE(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   ZRICHTUNGMERGED0206 = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data
%   from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   zrichtungmerged0206 = importfile('z-richtung_merged_0206.txt', 1, 1101);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/06/06 11:02:19
...
sensordataFC(:,2) = tmpSensordataFC(:,10); % / scaleGyro;
sensordataFC(:,3) = tmpSensordataFC(:,11); % / scaleGyro;
sensordataFC(:,4) = tmpSensordataFC(:,7); % / scaleGyro;
sensordataFC(:,5) = tmpSensordataFC(:,8); % / scaleAcc;
sensordataFC(:,6) = tmpSensordataFC(:,9); % / scaleAcc;
sensordataFC(:,7) = tmpSensordataFC(:,12); % / scaleAcc;
sensordataFC(:,8) = tmpSensordataFC(:,6); % * scaleMag;
sensordataFC(:,9) = tmpSensordataFC(:,2); % * scaleMag;
sensordataFC(:,10) = tmpSensordataFC(:,5); % * scaleMag;
