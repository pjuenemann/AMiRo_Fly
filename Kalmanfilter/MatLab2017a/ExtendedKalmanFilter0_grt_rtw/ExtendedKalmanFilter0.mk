###########################################################################
## Makefile generated for Simulink model 'ExtendedKalmanFilter0'. 
## 
## Makefile     : ExtendedKalmanFilter0.mk
## Generated on : Tue Apr 18 13:26:40 2017
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ExtendedKalmanFilter0.exe
...
PRODUCT_NAME              = ExtendedKalmanFilter0
MAKEFILE                  = ExtendedKalmanFilter0.mk
COMPUTER                  = PCWIN64
...
MODELREF_LINK_RSPFILE_NAME = ExtendedKalmanFilter0_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = ExtendedKalmanFilter0_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ExtendedKalmanFilter0.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/ExtendedKalmanFilter0_grt_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(START_DIR)/slprj/grt/_sharedutils
...
DEFINES_STANDARD = -DMODEL=ExtendedKalmanFilter0 -DNUMST=4 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/ExtendedKalmanFilter0_grt_rtw/ExtendedKalmanFilter0.c $(START_DIR)/ExtendedKalmanFilter0_grt_rtw/ExtendedKalmanFilter0_data.c rt_logging.c
...
OBJS = ExtendedKalmanFilter0.obj ExtendedKalmanFilter0_data.obj rt_logging.obj
...
%.obj : $(START_DIR)/ExtendedKalmanFilter0_grt_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
