...
MODEL     = ControllerForOriginSensordata
TARGET      = sfun
MODULE_SRCS   = 
MODEL_SRC  = ControllerForOriginSensordata_sfun.c
MODEL_REG = ControllerForOriginSensordata_sfun_registry.c
MAKEFILE    = ControllerForOriginSensordata_sfun.mak
...
MLSLSF_INCLUDES = \
    ...
    /I "C:\Users\Philipp\Desktop\Masterprojekt\Kalmanfilter\MatLab2017a\slprj\_sfprj\ControllerForOriginSensordata\_self\sfun\src" 
...
OBJLIST_FILE = ControllerForOriginSensordata_sfun.mol
SFCLIB = 
AUX_LNK_OBJS =     
USER_LIBS = 
#--------------------------------- Rules --------------------------------------
