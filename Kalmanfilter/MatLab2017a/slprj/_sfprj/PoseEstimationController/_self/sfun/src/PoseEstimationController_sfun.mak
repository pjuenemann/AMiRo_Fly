...
MODEL     = PoseEstimationController
TARGET      = sfun
MODULE_SRCS   = 
MODEL_SRC  = PoseEstimationController_sfun.c
MODEL_REG = PoseEstimationController_sfun_registry.c
MAKEFILE    = PoseEstimationController_sfun.mak
...
MLSLSF_INCLUDES = \
    ...
    /I "C:\Users\Philipp\Desktop\Masterprojekt\Kalmanfilter\MatLab2017a\slprj\_sfprj\PoseEstimationController\_self\sfun\src" 
...
OBJLIST_FILE = PoseEstimationController_sfun.mol
SFCLIB = 
AUX_LNK_OBJS =     
USER_LIBS = 
#--------------------------------- Rules --------------------------------------
