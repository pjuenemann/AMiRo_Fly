  ...
  unsigned int chartFileNumber, const char* specsCksum, int_T method, void *data)
{
  if (chartFileNumber==8) {
    if (!strcmp(specsCksum, "s6aIvTSJnqQahrg9TisWWy")) {
      c8_s6aIvTSJnqQahrg9TisWWy_sharedTrackingLibrary_method_dispatcher
        (simstructPtr, method, data);
      return 1;
    }

    if (!strcmp(specsCksum, "sbRIz0VG0HlbsUaKs60D4F")) {
      c8_sbRIz0VG0HlbsUaKs60D4F_sharedTrackingLibrary_method_dispatcher
        (simstructPtr, method, data);
      return 1;
    }
  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"sharedTrackingLibrary")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2965685085U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1446628343U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1306643166U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1776079343U);
        } else if (nrhs==4) {
          ...
          switch (chartFileNumber) {
           case 8:
            {
              extern void
                sf_c8_sbRIz0VG0HlbsUaKs60D4F_sharedTrackingLibrary_get_check_sum
                (mxArray *plhs[]);
              sf_c8_sbRIz0VG0HlbsUaKs60D4F_sharedTrackingLibrary_get_check_sum
                (plhs);
              break;
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 8:
      {
        if (strcmp(tpChksum, "s6aIvTSJnqQahrg9TisWWy") == 0) {
          extern mxArray
            *sf_c8_s6aIvTSJnqQahrg9TisWWy_sharedTrackingLibrary_third_party_uses_info
            (void);
          plhs[0] =
            sf_c8_s6aIvTSJnqQahrg9TisWWy_sharedTrackingLibrary_third_party_uses_info
            ();
        ...
        if (strcmp(tpChksum, "sbRIz0VG0HlbsUaKs60D4F") == 0) {
          extern mxArray
            *sf_c8_sbRIz0VG0HlbsUaKs60D4F_sharedTrackingLibrary_third_party_uses_info
            (void);
          plhs[0] =
            sf_c8_sbRIz0VG0HlbsUaKs60D4F_sharedTrackingLibrary_third_party_uses_info
            ();
     ...
     case 9:
      {
        if (strcmp(tpChksum, "sbB9uvtTZK1eNJGQxnG08UD") == 0) {
     ...
     case 8:
      {
        if (strcmp(tpChksum, "s6aIvTSJnqQahrg9TisWWy") == 0) {
          extern mxArray
            *sf_c8_s6aIvTSJnqQahrg9TisWWy_sharedTrackingLibrary_jit_fallback_info
            (void);
          plhs[0] =
            sf_c8_s6aIvTSJnqQahrg9TisWWy_sharedTrackingLibrary_jit_fallback_info
            ();
        ...
        if (strcmp(tpChksum, "sbRIz0VG0HlbsUaKs60D4F") == 0) {
          extern mxArray
            *sf_c8_sbRIz0VG0HlbsUaKs60D4F_sharedTrackingLibrary_jit_fallback_info
            (void);
          plhs[0] =
            sf_c8_sbRIz0VG0HlbsUaKs60D4F_sharedTrackingLibrary_jit_fallback_info
            ();
  ...
  boolean_T isModelRef, boolean_T isExternal)
{
  ...
  if (sRtwOptimizationInfoStruct==NULL) {
    sRtwOptimizationInfoStruct = sf_load_rtw_optimization_info(
      "sharedTrackingLibrary", "PoseEstimationController");
