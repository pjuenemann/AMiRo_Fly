...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3941036750U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(141914245U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(20018058U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1003581092U);
}
...
{
  return "sbB9uvtTZK1eNJGQxnG08UD";
}
...
static void mdlSetWorkWidths_c9_sharedTrackingLibrary(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2824024112U));
  ssSetChecksum1(S,(3974844372U));
  ssSetChecksum2(S,(3075795342U));
  ssSetChecksum3(S,(3821821531U));
