...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_ExtendedKalmanFilter0_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_sharedTrackingLibrary_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_ExtendedKalmanFilter0_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
...
{
  extern unsigned int sf_ExtendedKalmanFilter0_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "ExtendedKalmanFilter0") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_ExtendedKalmanFilter0_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int sf_ExtendedKalmanFilter0_third_party_uses_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "ExtendedKalmanFilter0") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_ExtendedKalmanFilter0_third_party_uses_info(nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int sf_ExtendedKalmanFilter0_jit_fallback_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "ExtendedKalmanFilter0") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_ExtendedKalmanFilter0_jit_fallback_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_updateBuildInfo_args_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_ExtendedKalmanFilter0_updateBuildInfo_args_info( int
  ...
  if (strcmp(machineName, "ExtendedKalmanFilter0") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_ExtendedKalmanFilter0_updateBuildInfo_args_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_eml_resolved_functions_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_ExtendedKalmanFilter0_get_eml_resolved_functions_info
  ...
  if (strcmp(machineName, "ExtendedKalmanFilter0") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_ExtendedKalmanFilter0_get_eml_resolved_functions_info(nlhs,plhs,2,
      newRhs);
  }
...
extern unsigned int sf_ExtendedKalmanFilter0_method_dispatcher(SimStruct *S,
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"ExtendedKalmanFilter0")) {
    return(sf_ExtendedKalmanFilter0_method_dispatcher(simstructPtr,
...
extern void ExtendedKalmanFilter0_terminator(void);
...
void sf_machine_global_terminator(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 0) {
    ExtendedKalmanFilter0_terminator();
...
extern void ExtendedKalmanFilter0_initializer(void);
extern void sharedTrackingLibrary_initializer(void);
extern void ExtendedKalmanFilter0_register_exported_symbols(SimStruct* S);
extern void sharedTrackingLibrary_register_exported_symbols(SimStruct* S);
extern void ExtendedKalmanFilter0_debug_initialize(struct SfDebugInstanceStruct*);
...
{
  ExtendedKalmanFilter0_register_exported_symbols(S);
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      ExtendedKalmanFilter0_debug_initialize(sfGlobalDebugInstanceStruct);
    }

    ExtendedKalmanFilter0_initializer();
    if (!simModeIsRTWGen) {
