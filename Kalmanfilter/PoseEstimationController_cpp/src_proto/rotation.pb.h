...
inline float Rotation::x() const {
  // @@protoc_insertion_point(field_get:twbTracking.proto.Rotation.x)
  return x_;
}
inline void Rotation::set_x(float value) {
  set_has_x();
  x_ = value;
  // @@protoc_insertion_point(field_set:twbTracking.proto.Rotation.x)
}
...
inline float Rotation::y() const {
  // @@protoc_insertion_point(field_get:twbTracking.proto.Rotation.y)
  return y_;
}
inline void Rotation::set_y(float value) {
  set_has_y();
  y_ = value;
  // @@protoc_insertion_point(field_set:twbTracking.proto.Rotation.y)
}
...
inline float Rotation::z() const {
  // @@protoc_insertion_point(field_get:twbTracking.proto.Rotation.z)
  return z_;
}
inline void Rotation::set_z(float value) {
  set_has_z();
  z_ = value;
  // @@protoc_insertion_point(field_set:twbTracking.proto.Rotation.z)
}
