...
Translation::Translation()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:twbTracking.proto.Translation)
}
...
Translation::Translation(const Translation& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:twbTracking.proto.Translation)
}
...
Translation::~Translation() {
  // @@protoc_insertion_point(destructor:twbTracking.proto.Translation)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:twbTracking.proto.Translation)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:twbTracking.proto.Translation)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:twbTracking.proto.Translation)
  return false;
#undef DO_
}
...
void Translation::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:twbTracking.proto.Translation)
  // required float x = 1;
  if (has_x()) {
  ...
  // @@protoc_insertion_point(serialize_end:twbTracking.proto.Translation)
}

::google::protobuf::uint8* Translation::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:twbTracking.proto.Translation)
  // required float x = 1;
  if (has_x()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:twbTracking.proto.Translation)
  return target;
}
