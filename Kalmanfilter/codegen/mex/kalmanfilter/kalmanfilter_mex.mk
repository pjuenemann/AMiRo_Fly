START_DIR = C:\Users\Philipp\Desktop\MASTER~1\KALMAN~1

MATLAB_ROOT = C:\PROGRA~1\MATLAB\R2015b
MAKEFILE = kalmanfilter_mex.mk

include kalmanfilter_mex.mki
...
MEX_FILE_NAME_WO_EXT = kalmanfilter_mex
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\kalmanfilter"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\kalmanfilter/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
